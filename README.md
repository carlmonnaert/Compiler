...
# Getting started :
## C compiler
For this project, the files are located in [eval_micro_C](eval_micro_C). To use the compiler, write C code in [file.c](file.c) and run [interpreter.sh](interpreter.sh)
